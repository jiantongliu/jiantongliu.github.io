...
<table>
    ...
    <tbody style="text-align:center">
        ...
        <tr>
            <td style="width: 10%;">Mar. 29</td>
            <td style="width: 15%;">Levi Poon</td>
            <td style="width: 35%;">Spectral Categories and Stable $\infty$-categories</td>
            <td style="width: 40%;">Blumberg et al., <a href = "https://projecteuclid.org/journals/geometry-and-topology/volume-17/issue-2/A-universal-characterization-of-higher-algebraic-Kmkern-4mutheory/10.2140/gt.2013.17.733.full">A Universal Characterization of Higher Algebraic K-theory</a> (2013)</td>
        </tr>
    </tbody>
</table>
